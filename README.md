...
This website is hosted by GitHub. It can display a website from .md files, although it requires a few minutes to deploy. It cannot display mathematical equations from Latex script, however.
